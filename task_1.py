...
Приклад:
Якщо сьогодні 5 травня 2021 року, виклик get_days_from_today("2021-10-09") повинен повернути 157, оскільки 9 жовтня 2021
року є на 157 днів пізніше від 5 травня 2021 року.
"""

from datetime import datetime


def string_to_date(date_str: str, fmt) -> datetime.date:
    return datetime.strptime(date_str, fmt).date()


def get_days_from_today(date: str) -> int:
    try:
        date = string_to_date(date, fmt="%Y-%m-%d")
    except ValueError:
        print('Invalid date format (correct: YYYY-MM-DD)')
        return 0

    today = datetime.today().date()

    # В завданні вказано "Якщо задана дата пізніша за поточну, результат має бути від'ємним." Але в прикладі
    # "Якщо сьогодні 5 травня 2021 року, виклик get_days_from_today("2021-10-09") повинен повернути 157"
    # Трохи розбігається з вимогами
